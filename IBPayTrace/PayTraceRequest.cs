...
namespace IBPayTrace
{
    ...
    public class ApiAccessCredentials
    {
        ...
        {
            return string.Format("grant_type={0}&username={1}&password={2}", "password", Globals.userName, Globals.passWord);
        }
    }
    ...
    /// <summary>
    /// Class for customer export. 
    /// </summary>
    public class DownloadCustomersRequest
    {
